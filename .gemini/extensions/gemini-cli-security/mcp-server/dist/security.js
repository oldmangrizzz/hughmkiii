...
export async function findLineNumbers({ filePath, snippet, }, dependencies = { fs, path }) {
    try {
        const CWD = process.cwd();
        const safeFilePath = await dependencies.fs.realpath(dependencies.path.resolve(CWD, filePath));
